...
<table width="88%" border="0" class="emp_table" style="width:80%;">
  ...
  <tr>
    <td width="10%">课程类别：</td>
    <td width="20%"><s:textfield name="" value=""></s:textfield></td>
    <td width="8%">总学时：</td>
    <td width="62%"><s:textfield name="" value=""></s:textfield></td>
  </tr>
  <tr>
    <td>课程费用：</td>
  ...
  <tr>
    <td></td>
    <td colspan="4"><s:textarea name="" cols="60" rows="10">CKEditor</s:textarea></td>
  </tr>
    <tr>
    <td></td>
